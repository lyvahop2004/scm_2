...
//   return new Promise(async (resolve, reject) => {
//     try {
//       if (!data.userId || !data.shipPhonenumber) {
//         resolve({
//           errCode: 1,
//           errMessage: "Missing required parameter!",
//         });
...
//       // Kiểm tra số điện thoại đã tồn tại trong bảng AddressUser
//       let phoneExists = await db.AddressUser.findOne({
//         where: { shipPhonenumber: data.shipPhonenumber },
//       });
...
//       // Tạo địa chỉ mới nếu không bị trùng
//       await db.AddressUser.create({
//         userId: data.userId,
//         shipName: data.shipName,
//         shipAdress: data.shipAdress,
