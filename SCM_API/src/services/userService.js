...
//         if (user) {
//           // Kiểm tra số điện thoại đã tồn tại chưa, ngoại trừ số của chính người dùng hiện tại
//           let isPhoneNumberExists = await db.User.findOne({
//             where: {
//               phonenumber: data.phonenumber,
//               id: { [db.Sequelize.Op.ne]: data.id }, // Loại trừ người dùng hiện tại
//             },
//           });
